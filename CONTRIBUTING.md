...
Feature requests, bugs, support requests, and milestones are tracked via the [BLT SimpleSamlPhp GitHub issue queue](https://github.com/acquia/blt-simplesamlphp/issues).
